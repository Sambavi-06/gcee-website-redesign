export const deptData = {
  ...
  "ds": {
    "title": "Data Science",
    "desc": "The Data Science department focuses on artificial intelligence, machine learning, big data analytics, and applied computational intelligence. The programme is designed to prepare students for data-driven engineering and research careers through strong mathematical foundations, modern software practices, and industry-integrated learning.",
    "img": "https://www.gcee.ac.in/assets/img/main/cse01.jpg",
    "staff": [
      {
        "name": "Dr. N. Magesh",
        ...
        "img": "https://www.gcee.ac.in/include/ajax/cse/assistant_professor3.jpg",
        "details": "Qualification: M.E., Ph.D<br>Experience : 24 Years<br>Area of Specialization : Machine Learning, Data Analytics, Image Processing<br>Journals : 16<br>Contact Number : +91-9442837703"
      },
      {
        "name": "Dr. I. Bhuvaneshwarri",
        "role": "Associate Professor, Data Science",
        "img": "https://www.gcee.ac.in/include/ajax/it/assistant_professor1.jpg",
        "details": "Qualification: M.E., Ph.D<br>Experience : 23 Years<br>Area of Specialization : Big Data Analytics, Data Mining, Network Security<br>Patents : 1"
      },
      {
        "name": "Dr. M. Sathyakala",
        "role": "Assistant Professor, Data Science",
        "img": "https://www.gcee.ac.in/include/ajax/it/assistant_professor7.jpg",
        "details": "Qualification: M.Tech., Ph.D<br>Experience : 15 Years<br>Area of Specialization : Data Mining, Applied AI<br>Conference & Journals : 3 & 4"
      }
    ],
    "labs": [
      {
        ...
        "description": "GPU-enabled systems for model development, experimentation, and deployment.",
        "equipment": "High-end workstations, CUDA GPUs, model training servers",
        "research": "Deep learning for vision, NLP, and predictive analytics"
      },
      {
        "img": "https://www.gcee.ac.in/include/ajax/cse/lab/img2.jpg",
        "name": "Big Data Analytics Lab",
        "description": "Cluster environment for large-scale distributed data processing and analytics.",
        "equipment": "Hadoop/Spark cluster, scalable storage, cloud tools",
        "research": "Data engineering pipelines and smart city analytics"
      },
      {
        "img": "https://www.gcee.ac.in/include/ajax/cse/lab/img3.jpg",
        "name": "Business Intelligence and Visualization Lab",
        "description": "Interactive analytics and dashboard development environment.",
        "equipment": "BI software stack, interactive display systems",
        "research": "Decision intelligence and educational analytics"
      }
    ],
    "hod": {
      "name": "Dr. A. Kavitha",
      "role": "Professor & Head, Data Science",
      "img": "https://www.gcee.ac.in/include/ajax/cse/associate_professor3.jpg",
      "details": "Qualification: M.E., Ph.D<br>Experience : 32 Years<br>Area of Specialization : Semantic Web, Artificial Intelligence<br>Conferences & Journals : 9"
    },
    "achievements": [
      "Introduced AI and Data Science focused curriculum aligned with industry needs",
      "Student teams presented data analytics projects in inter-college showcases",
      "Faculty initiated research in machine learning and semantic technologies"
    ],
    "facilities_desc": "The department maintains a specialized analytics computing environment with industry-relevant software and collaborative project spaces.",
    "projects": [
      {
        "sno": "1",
        "title": "Predictive Analytics for Campus Energy Optimization",
      ...
      {
        "sno": "2",
        "title": "AI-Assisted Transportation Data Modeling",
...
export const defaultDept = {
  ...
  staff: [{ name: 'Dr. Staff Member', role: 'Professor', img: 'https://www.gcee.ac.in/assets/img/blog/img2.jpg', details: 'Qualification: M.E., Ph.D' }]
};
